    ...
    <form onSubmit={onSubmitHandler} className='min-h-[80vh] flex items-center' >
      <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-gray-600 text-sm shadow-lg'>
        ...
        <p>Please {state === 'Sign Up' ? "Sign Up" : "Login"} to book an appointment</p>
        {
          ...
          <p>Full Name</p>
          <input className='border border-gray-300 rounded w-full p-2 mt-1' type="name" onChange={(e) => setName(e.target.value)} value={name} required />
        </div>
        ...
        <div className='w-full'>
          <p>Email</p>
          <input className='border border-gray-300 rounded w-full p-2 mt-1' type="email" onChange={(e) => setEmail(e.target.value)} value={email} required />
        </div>
        <div className='w-full'>
          <p>Password</p>
          <input className='border border-gray-300 rounded w-full p-2 mt-1' type="password" onChange={(e) => setPassword(e.target.value)} value={password} required/>
        </div>
